...
<head>
    <meta charset="utf-8">
    <title>Stalwart it solution</title>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{ ('portfolioss') }}" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Portfolio</a>
                    <a href="{{ ('teams') }}" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Teams</a>
                    <a href="{{ ('blogs') }}" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Blogs</a>
                    <a href="{{ ('contact') }}" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Contact us</a>
