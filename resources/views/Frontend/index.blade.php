    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center">
          <h1 data-aos="fade-up">Website and Mobile App. Development Company in Ahmedabad</h1>
          <h2 data-aos="fade-up" data-aos-delay="400">Expert team for all your software application development needs, whether it is a simple business website, E-commerce, or a mobile application.</h2>
    ...
    <section id="values" class="values">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <header class="section-header">
          <h2>Our Values</h2>
          <p>Stalwart It Solution</p>
          <p> Your One-Stop IT Maintenance and Consulting Partner</p>
        </header>
        ...
        <div class="row">
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
            <div class="box">
              ...
              <p>Unlock the full potential of your IT strategy with our expert IT Consultation services. Our seasoned advisors provide tailored insights, technology roadmaps, and solutions to help your business make informed decisions and achieve its digital goals.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="400">
            <div class="box">
              ...
              <p>Experience reliable and secure server hosting solutions with us. Our hosting services provide the foundation for your online presence, offering top-notch performance, scalability, and 24/7 support to keep your business running smoothly.</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 mt-4 mt-lg-0" data-aos="fade-up" data-aos-delay="600">
            <div class="box">
              ...
              <h3>Web-Mobile Maintenance Services</h3>
              <p>Ensure the seamless performance of your web and mobile applications with our Annual Maintenance Services. Stay worry-free while we handle the maintenance, so you can focus on your core business.</p>
            </div>
          </div>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="count-box">
              ...
              <div>
                <span data-purecounter-start="0" data-purecounter-end="130" data-purecounter-duration="1" class="purecounter plus"></span><span class="plus"> +</span>
                <p>Happy Clients</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="count-box">
              ...
              <div>
                <span data-purecounter-start="0" data-purecounter-end="300" data-purecounter-duration="1" class="purecounter plus"></span><span class="plus"> +</span>
                <p>Projects</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="count-box">
              ...
              <div>
                <span data-purecounter-start="0" data-purecounter-end="2400" data-purecounter-duration="1" class="purecounter plus"></span><span class="plus"> +</span>
        ...
        <div class="row">
          ...
          <div class="col-lg-4">
            <div class="post-box">
              ...
              <a href="blog-single.blade.php" class="readmore stretched-link mt-auto"><span>Read More</span><i class="bi bi-arrow-right"></i></a>
            </div>
          </div>
